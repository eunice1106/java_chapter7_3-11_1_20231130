...
public class StringTest {
	...
	public static void main(String[] args) {
		...
		String ssn = "880123-1049521";
		
		char ssnGender = ssn.charAt(7);
		
				
		if(ssnGender == '1' ) {//''는 숫자.""는 문자
			System.out.println("남자");
		} else {
			System.out.println("여자");
		}
		
		int re1 = ssn.indexOf("521");
		//해당문자열이 존재하면 그 문자열이 시작되는 인덱스 번호를 반환 -> 해당 문자열이 존재하지 않으면 -1로 반환
		
		System.out.println(re1);
		
		
		String str00 = "김길동 김길수";
		String str11 = str00.replace("김", "홍");//"김"을 "홍"으로 바꿈
	 	
		System.out.println(str11);
		
		
		System.out.println(ssn.substring(0, 6));//인덱스 0~5까지 슬라이싱(6은 포함안됨)
		...
		Integer int1 = new Integer(strnum);//옛날방식
